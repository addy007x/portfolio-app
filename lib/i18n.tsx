...
const DICTIONARY: Record<string, Record<Language, string>> = {
  ...
  "earn.editHelp": {
    th: "จำนวนเหรียญตั้งต้นคือยอดฝากตอนเริ่ม ไม่ใช่ยอดที่ทบต้นแล้วในปัจจุบัน ระบบจะคำนวณดอกเบี้ยทบต้นใหม่ ตามค่าที่แก้ไข",
    en: "The starting quantity is the original deposit, not today's compounded total. Interest will be recalculated from the values you edit.",
  },

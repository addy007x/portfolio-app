...
const DICTIONARY: Record<string, Record<Language, string>> = {
  ...
  "plan.paceLead": {
    th: "เหลืออีก {count} {unit} ต้องลงเฉลี่ย",
    en: "{count} {unit}s left — invest on average",
  },
  "plan.paceRemaining": { th: "ยอดที่เหลือทั้งหมด {amount}", en: "{amount} remaining in total" },
  "plan.freq.day": { th: "รายวัน", en: "Daily" },
  "plan.freq.week": { th: "รายสัปดาห์", en: "Weekly" },
  "plan.freq.month": { th: "รายเดือน", en: "Monthly" },
  "plan.unit.day": { th: "วัน", en: "day" },
  "plan.unit.week": { th: "สัปดาห์", en: "week" },
  "plan.unit.month": { th: "เดือน", en: "month" },
  "plan.paceBehind": {
  ...
  // No space before {unit}: Thai reads "ต้องลงวันละ", not "ต้องลง วันละ".
  "plan.rowPace": { th: "ต้องลง{unit}ละ {amount}", en: "{amount} / {unit}" },
  ...
  "nav.profit": { th: "กำไร", en: "Profit" },
  "profit.title": { th: "กำไร", en: "Profit" },
  "profit.year": { th: "ปี", en: "" },
  "profit.realizedTitle": { th: "กำไรที่ขายแล้ว", en: "Realized profit" },
  "profit.realizedTotal": { th: "กำไรที่ขายแล้วทั้งหมด", en: "Total realized profit" },
  "profit.noSales": {
    th: "ยังไม่มีรายการขายในปีนี้",
    en: "No sales recorded this year",
  },
  "profit.tradeCount": { th: "จำนวนครั้งที่ขาย", en: "Sales" },
  "profit.times": { th: "ครั้ง", en: "" },
  "profit.avgPerTrade": { th: "กำไรเฉลี่ยต่อการขาย", en: "Avg per sale" },
  "profit.winRate": { th: "อัตราชนะ", en: "Win rate" },
  "profit.profitFactor": { th: "Profit Factor", en: "Profit factor" },
  "profit.monthlyTitle": { th: "กำไรที่ขายแล้วรายเดือน", en: "Realized profit by month" },
  "profit.bestMonth": { th: "กำไรสูงสุดต่อเดือน", en: "Best month" },
  "profit.worstMonth": { th: "ขาดทุนสูงสุดต่อเดือน", en: "Worst month" },
  "profit.realizedNote": {
    th: "คำนวณจากรายการขาย โดยใช้ต้นทุนเฉลี่ย ณ เวลาที่ขาย",
    en: "Calculated from sales, using the average cost at the time of each sale",
  },
  "profit.unrealizedTitle": { th: "กำไรที่ยังไม่ขาย", en: "Unrealized profit" },
  "profit.unrealizedTotal": { th: "กำไรที่ยังไม่ขายทั้งหมด", en: "Total unrealized profit" },
  "profit.noHoldings": {
    th: "ยังไม่มีสินทรัพย์ที่บันทึกต้นทุนไว้",
    en: "No holdings with a recorded cost basis",
  },
  "profit.byHolding": { th: "รายละเอียดกำไรที่ยังไม่ขาย", en: "Unrealized profit by asset" },
  "profit.barValue": { th: "มูลค่า", en: "Value" },
  "profit.barPct": { th: "% กำไร", en: "% gain" },
  "profit.showAll": { th: "ดูทั้งหมด {count} รายการ", en: "Show all {count}" },
  "profit.showLess": { th: "ย่อ", en: "Show less" },
  "profit.catStock": { th: "หุ้น", en: "Stocks" },
  "profit.catCrypto": { th: "คริปโต", en: "Crypto" },
  "profit.catGold": { th: "ทอง", en: "Gold" },
  "profit.catCash": { th: "เงินสด", en: "Cash" },
  "nav.rebalance": { th: "ปรับสมดุล", en: "Rebalance" },
  "rebalance.title": { th: "ปรับสมดุลพอร์ต", en: "Rebalance" },
  "rebalance.subtitle": {
    th: "ปรับสัดส่วนพอร์ตให้กลับมาตามเป้าหมาย",
    en: "Bring the portfolio back to its target mix",
  },
  "rebalance.portfolioValue": { th: "มูลค่าพอร์ต", en: "Portfolio value" },
  "rebalance.drift": { th: "ส่วนเบี่ยงเบน", en: "Drift" },
  "rebalance.driftHigh": { th: "ควรปรับสมดุล", en: "Rebalancing suggested" },
  "rebalance.driftOk": { th: "อยู่ในเกณฑ์ดี", en: "Within range" },
  "rebalance.targetNot100": {
    th: "สัดส่วนเป้าหมายรวมได้ {total}% (ควรเป็น 100%)",
    en: "Targets add up to {total}% (should be 100%)",
  },
  "rebalance.allocationTitle": { th: "การกระจายสัดส่วน", en: "Allocation" },
  "rebalance.target": { th: "เป้าหมาย", en: "Target" },
  "rebalance.current": { th: "ปัจจุบัน", en: "Current" },
  "rebalance.modeTitle": { th: "วิธีปรับสมดุล", en: "Rebalance method" },
  "rebalance.mode.dca": { th: "ใช้เงินใหม่ (ไม่ขาย)", en: "New money only (no selling)" },
  "rebalance.modeHelp.dca": {
    th: "ใช้เงินลงทุนใหม่ซื้อเฉพาะสินทรัพย์ที่ต่ำกว่าเป้า ไม่ต้องขายอะไร จึงไม่เกิดกำไร/ขาดทุนตามจริง",
    en: "Spends new cash on whatever is below target. Nothing is sold, so no gains are realized.",
  },
  "rebalance.mode.sellExcess": { th: "ขายส่วนที่เกิน", en: "Trim what's over" },
  "rebalance.modeHelp.sellExcess": {
    th: "ขายเฉพาะสินทรัพย์ที่เกินเป้าชัดเจน แล้วนำเงินไปซื้อตัวที่ขาด ไม่ต้องใช้เงินใหม่",
    en: "Sells only what is clearly above target and buys what's short with the proceeds. No new money needed.",
  },
  "rebalance.mode.full": { th: "ปรับเต็มรูปแบบ", en: "Full rebalance" },
  "rebalance.modeHelp.full": {
    th: "ปรับทุกสินทรัพย์ให้ตรงเป้าหมายเป๊ะ แม้ต่างเพียงเล็กน้อย จำนวนรายการซื้อขายจะมากที่สุด",
    en: "Moves every position onto its exact target, however small the gap. The most transactions.",
  },
  "rebalance.dcaAmount": { th: "จำนวนเงินที่จะลงทุนเพิ่ม", en: "Amount to invest" },
  "rebalance.suggestionTitle": { th: "คำแนะนำ", en: "Suggested trades" },
  "rebalance.sell": { th: "ขาย", en: "Sell" },
  "rebalance.buy": { th: "ซื้อ", en: "Buy" },
  "rebalance.total": { th: "รวม", en: "Total" },
  "rebalance.nothingToDo": {
    th: "สัดส่วนใกล้เคียงเป้าหมายแล้ว ไม่ต้องปรับ",
    en: "Close enough to target — nothing to do",
  },
  "rebalance.enterDca": { th: "ใส่จำนวนเงินที่จะลงทุนเพิ่ม", en: "Enter an amount to invest" },
  "rebalance.shortfall": {
    th: "เงินไม่พอปรับให้ครบทุกตัว ยังขาดอีก {amount}",
    en: "Not enough to close every gap — {amount} short",
  },
  "rebalance.compareTitle": { th: "เปรียบเทียบสัดส่วน", en: "Target vs current" },
  "rebalance.over": { th: "เกิน", en: "Over" },
  "rebalance.under": { th: "ขาด", en: "Under" },
  "rebalance.onTarget": { th: "ตรงเป้า", en: "On target" },
  "rebalance.note": {
    th: "คำแนะนำนี้เป็นเพียงการคำนวณตามสัดส่วนที่ตั้งไว้ ไม่ได้ส่งคำสั่งซื้อขายจริง และยังไม่รวมค่าธรรมเนียมหรือภาษี",
    en: "These are calculations against your target mix only — no orders are placed, and fees and tax aren't included.",
  },
  "rebalance.emptyTitle": { th: "ยังไม่ได้ตั้งสัดส่วนเป้าหมาย", en: "No target mix set" },
  "rebalance.emptyHelp": {
    th: "ตั้งว่าอยากให้พอร์ตมีสัดส่วนเท่าไหร่ แล้วระบบจะบอกว่าต้องซื้อหรือขายอะไรบ้าง",
    en: "Set what you want the portfolio to look like and you'll get buy/sell suggestions.",
  },
  "rebalance.emptyNoHoldings": {
    th: "เพิ่มสินทรัพย์ในพอร์ตก่อน แล้วจึงตั้งสัดส่วนเป้าหมายได้",
    en: "Add holdings to the portfolio first, then you can set a target mix.",
  },
